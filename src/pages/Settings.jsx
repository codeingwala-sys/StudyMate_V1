...
export default function Settings() {
  ...
  const handleHardReset = async () => {
    if (!window.confirm('This will clear the app cache and reload. Your study data (notes, tasks) will be safe. Proceed?')) return
          ...
          <div style={{ padding:'16px 18px' }}>
            <div style={{ display:'flex',alignItems:'center',gap:14,marginBottom:14,paddingBottom:14,borderBottom:`1px solid ${T.border2}` }}>
              ...
              <div>
                ...
                <p style={{ fontSize:12,color:T.muted,fontFamily:'Inter,sans-serif',marginTop:2 }}>Version 1.1.1 · AI-powered</p>
              </div>
            </div>
